...
HD_PWD='D:/WorkSpace/HDL/yadro_practice/project/apuf_parallel_uart_v1.0/apuf_parallel_uart_v1.0.runs/apuf_parallel_uart_design_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apuf_parallel_uart_design_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apuf_parallel_uart_design_rst_ps7_0_50M_0.tcl
