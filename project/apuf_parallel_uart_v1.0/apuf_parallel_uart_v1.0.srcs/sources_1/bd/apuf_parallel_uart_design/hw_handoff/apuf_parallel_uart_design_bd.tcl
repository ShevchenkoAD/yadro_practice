...
################################################################
# This is a generated script based on design: apuf_parallel_uart_design
#
...
# source apuf_parallel_uart_design_script.tcl
...
set design_name apuf_parallel_uart_design
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set debug_state [ create_bd_port -dir O -from 2 -to 0 debug_state ]
  set rst_n [ create_bd_port -dir I -type rst rst_n ]

  # Create instance: apuf_parallel_0, and set properties
  set apuf_parallel_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:apuf_parallel:1.0 apuf_parallel_0 ]
  ...
  set uart_tx_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:uart_tx:1.0 uart_tx_0 ]
  ...
  connect_bd_net -net apuf_parallel_0_debug_state_o [get_bd_ports debug_state] [get_bd_pins apuf_parallel_0/debug_state_o]
  connect_bd_net -net apuf_parallel_0_tx_data_o [get_bd_pins apuf_parallel_0/tx_data_o] [get_bd_pins uart_tx_0/tx_byte_i]
  connect_bd_net -net apuf_parallel_0_tx_dv_o [get_bd_pins apuf_parallel_0/tx_dv_o] [get_bd_pins uart_tx_0/tx_dv_i]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_pins axi_uartlite_0/tx] [get_bd_pins uart_rx_0/rx_serial_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins apuf_parallel_0/clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins uart_rx_0/clk] [get_bd_pins uart_tx_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_n_0_1 [get_bd_ports rst_n] [get_bd_pins apuf_parallel_0/rst_n] [get_bd_pins uart_rx_0/rst_n] [get_bd_pins uart_tx_0/rst_n]
  ...
  connect_bd_net -net uart_rx_0_rx_byte_o [get_bd_pins apuf_parallel_0/rx_data_i] [get_bd_pins uart_rx_0/rx_byte_o]
  connect_bd_net -net uart_rx_0_rx_dv_o [get_bd_pins apuf_parallel_0/rx_dv_i] [get_bd_pins uart_rx_0/rx_dv_o]
  connect_bd_net -net uart_tx_0_tx_active_o [get_bd_pins apuf_parallel_0/tx_active_i] [get_bd_pins uart_tx_0/tx_active_o]
  connect_bd_net -net uart_tx_0_tx_serial_o [get_bd_pins axi_uartlite_0/rx] [get_bd_pins uart_tx_0/tx_serial_o]
