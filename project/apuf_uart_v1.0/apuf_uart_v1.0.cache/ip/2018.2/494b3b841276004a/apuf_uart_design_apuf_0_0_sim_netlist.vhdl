...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_apuf is
  ...
  signal apuf_path_inst_0_i_3_n_0 : STD_LOGIC;
  ...
  signal \apuf_state_next__0\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal cycles_counter_ff : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal \cycles_counter_ff[0]_i_1_n_0\ : STD_LOGIC;
  signal \cycles_counter_ff[10]_i_2_n_0\ : STD_LOGIC;
  signal \cycles_counter_ff[10]_i_3_n_0\ : STD_LOGIC;
  signal \cycles_counter_ff[10]_i_4_n_0\ : STD_LOGIC;
  signal \cycles_counter_ff[10]_i_5_n_0\ : STD_LOGIC;
  signal \cycles_counter_ff[10]_i_6_n_0\ : STD_LOGIC;
  ...
  signal \cycles_counter_ff[5]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \cycles_counter_ff[9]_i_2_n_0\ : STD_LOGIC;
  signal \cycles_counter_ff[9]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_apuf_state_ff[2]_i_5\ : label is "soft_lutpair78";
  ...
  attribute SOFT_HLUTNM of \cycles_counter_ff[10]_i_5\ : label is "soft_lutpair78";
begin
  tx_dv_o <= \^tx_dv_o\;
\FSM_sequential_apuf_state_ff[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E200"
    )
        port map (
...
\FSM_sequential_apuf_state_ff[2]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\FSM_sequential_apuf_state_ff[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEFF"
    )
        port map (
...
apuf_path_inst_0_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2000"
    )
        port map (
...
\cycles_counter_ff[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0FFF8F0F0F0F8F0"
    )
        port map (
...
\cycles_counter_ff[10]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00D7D7D7"
    )
        port map (
...
\cycles_counter_ff[10]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\cycles_counter_ff[10]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0E00"
    )
        port map (
...
\cycles_counter_ff[10]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\cycles_counter_ff[10]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\cycles_counter_ff[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0090"
    )
        port map (
...
\cycles_counter_ff[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000E100"
    )
        port map (
...
\cycles_counter_ff[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\cycles_counter_ff[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\cycles_counter_ff[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0090"
    )
        port map (
...
\cycles_counter_ff[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\cycles_counter_ff[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0090"
    )
        port map (
...
\cycles_counter_ff[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000E100"
    )
        port map (
...
\cycles_counter_ff[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000FE010000"
    )
        port map (
...
\cycles_counter_ff[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFE000100000000"
    )
        port map (
...
\cycles_counter_ff[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\cycles_counter_ff[9]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
