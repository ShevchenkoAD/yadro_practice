...
HD_PWD='D:/WorkSpace/HDL/yadro_practice/project/apuf_uart_v1.0/apuf_uart_v1.0.runs/apuf_uart_design_uart_rx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apuf_uart_design_uart_rx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apuf_uart_design_uart_rx_0_0.tcl
