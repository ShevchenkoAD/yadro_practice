...
HD_PWD='D:/WorkSpace/HDL/yadro_practice/project/apuf_uart_v1.0/apuf_uart_v1.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log apuf_uart_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source apuf_uart_design_wrapper.tcl -notrace
