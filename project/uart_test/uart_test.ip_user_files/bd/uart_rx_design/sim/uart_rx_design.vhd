...
entity uart_rx_design is
  ...
  attribute CORE_GENERATION_INFO of uart_rx_design : entity is "uart_rx_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=uart_rx_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of uart_rx_design is
  ...
  attribute X_INTERFACE_PARAMETER of i_Clk_0 : signal is "XIL_INTERFACENAME CLK.I_CLK_0, CLK_DOMAIN uart_rx_design_i_Clk_0, FREQ_HZ 100000000, PHASE 0.000";
