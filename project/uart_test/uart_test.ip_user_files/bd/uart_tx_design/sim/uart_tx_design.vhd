...
entity uart_tx_design is
  port (
    ...
    i_BUT_0 : in STD_LOGIC;
    i_Clk_0 : in STD_LOGIC;
    i_SW_0 : in STD_LOGIC_VECTOR ( 3 downto 0 );
    o_LED_0 : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of uart_tx_design : entity is "uart_tx_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=uart_tx_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of uart_tx_design is
  ...
  signal i_BUT_0_1 : STD_LOGIC;
  signal i_Clk_0_1 : STD_LOGIC;
  signal i_SW_0_1 : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal test_in_0_i_TX_Byte : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal test_in_0_i_TX_DV : STD_LOGIC;
  signal test_in_0_o_LED : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute X_INTERFACE_INFO of i_Clk_0 : signal is "xilinx.com:signal:clock:1.0 CLK.I_CLK_0 CLK";
  attribute X_INTERFACE_PARAMETER of i_Clk_0 : signal is "XIL_INTERFACENAME CLK.I_CLK_0, CLK_DOMAIN uart_tx_design_i_Clk_0, FREQ_HZ 100000000, PHASE 0.000";
...
begin
  i_BUT_0_1 <= i_BUT_0;
  i_Clk_0_1 <= i_Clk_0;
  i_SW_0_1(3 downto 0) <= i_SW_0(3 downto 0);
  o_LED_0(3 downto 0) <= test_in_0_o_LED(3 downto 0);
UART_TX_0: component uart_tx_design_UART_TX_0_0
     port map (
      i_Clk => processing_system7_0_FCLK_CLK0,
      i_TX_Byte(7 downto 0) => test_in_0_i_TX_Byte(7 downto 0),
      i_TX_DV => test_in_0_i_TX_DV,
...
processing_system7_0: component uart_tx_design_processing_system7_0_0
     port map (
      ...
      UART1_RX => UART_TX_0_o_TX_Serial,
...
test_in_0: component uart_tx_design_test_in_0_0
     port map (
      i_BUT => i_BUT_0_1,
      i_Clk => i_Clk_0_1,
      i_SW(3 downto 0) => i_SW_0_1(3 downto 0),
      i_TX_Byte(7 downto 0) => test_in_0_i_TX_Byte(7 downto 0),
      i_TX_DV => test_in_0_i_TX_DV,
      o_LED(3 downto 0) => test_in_0_o_LED(3 downto 0)
    );
end STRUCTURE;
