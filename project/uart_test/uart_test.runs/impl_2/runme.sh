...
HD_PWD='D:/WorkSpace/HDL/uart_test/uart_test.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log uart_tx_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_tx_design_wrapper.tcl -notrace
