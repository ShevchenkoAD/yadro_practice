...
HD_PWD='D:/WorkSpace/HDL/uart_test/uart_test.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log uart_tx_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_tx_design_wrapper.tcl
