...
HD_PWD='D:/WorkSpace/HDL/uart_test/uart_test.runs/uart_rx_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_rx_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_rx_design_auto_pc_0.tcl
