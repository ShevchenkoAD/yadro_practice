...
HD_PWD='D:/WorkSpace/HDL/uart_test/uart_test.runs/uart_rx_design_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_rx_design_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_rx_design_axi_uartlite_0_0.tcl
