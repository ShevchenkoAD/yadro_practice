...
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { o_LED_0 }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
#set_property IOSTANDARD LVCMOS33 [get_ports o_LED_0]
                                                        
#set_property IOSTANDARD LVCMOS33 [get_ports o_LED_0[*]]##RGB LED 5 (Zybo Z7-20 only)
