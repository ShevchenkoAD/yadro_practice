...
##Clock signal
#set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { i_Clk_0 }]; #IO_L12P_T1_MRCC_35 Sch=sysclk
#set_property IOSTANDARD LVCMOS33 [get_ports i_Clk_0]
#create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { sysclk }];


##Switches
#set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { i_SW_0[0] }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { i_SW_0[1] }]; #IO_L24P_T3_34 Sch=sw[1]
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { i_SW_0[2] }]; #IO_L4N_T0_34 Sch=sw[2]
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { i_SW_0[3] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
#set_property IOSTANDARD LVCMOS33 [get_ports i_SW_0[*]]

##Buttons
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { i_BUT_0 }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
#set_property IOSTANDARD LVCMOS33 [get_ports i_BUT_0]
