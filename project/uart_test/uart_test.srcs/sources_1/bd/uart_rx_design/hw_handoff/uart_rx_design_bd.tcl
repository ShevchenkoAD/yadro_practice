...
################################################################
# This is a generated script based on design: uart_rx_design
#
...
# source uart_rx_design_script.tcl
...
set design_name uart_rx_design
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set i_SW_0 [ create_bd_port -dir I i_SW_0 ]
  ...
  # Create instance: test_out_0, and set properties
  set block_name test_out
  set block_cell_name test_out_0
  if { [catch {set test_out_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_out_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net UART_RX_0_o_RX_Byte [get_bd_pins UART_RX_0/o_RX_Byte] [get_bd_pins test_out_0/i_RX_Byte]
  connect_bd_net -net UART_RX_0_o_RX_DV [get_bd_pins UART_RX_0/o_RX_DV] [get_bd_pins test_out_0/i_RX_DV]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_pins UART_RX_0/i_RX_Serial] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net i_SW_0_1 [get_bd_ports i_SW_0] [get_bd_pins test_out_0/i_SW]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins UART_RX_0/i_Clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins test_out_0/i_Clk]
  ...
  connect_bd_net -net test_out_0_o_LED [get_bd_ports o_LED_0] [get_bd_pins test_out_0/o_LED]
