...
################################################################
# This is a generated script based on design: uart_tx_design
#
...
# source uart_tx_design_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# UART_RX, UART_TX, test_in
...
set design_name uart_tx_design
...
proc create_root_design { parentCell } {
  ...
  # Create instance: test_in_0, and set properties
  set block_name test_in
  set block_cell_name test_in_0
  if { [catch {set test_in_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_in_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net UART_RX_0_o_RX_Byte [get_bd_pins UART_RX_0/o_RX_Byte] [get_bd_pins test_in_0/i_RX_Byte]
  connect_bd_net -net UART_RX_0_o_RX_DV [get_bd_pins UART_RX_0/o_RX_DV] [get_bd_pins test_in_0/i_RX_DV]
  connect_bd_net -net UART_TX_0_o_TX_Serial [get_bd_pins UART_TX_0/o_TX_Serial] [get_bd_pins axi_uartlite_0/rx]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_pins UART_RX_0/i_RX_Serial] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins UART_RX_0/i_Clk] [get_bd_pins UART_TX_0/i_Clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins test_in_0/i_Clk]
  ...
  connect_bd_net -net test_in_0_o_TX_Byte [get_bd_pins UART_TX_0/i_TX_Byte] [get_bd_pins test_in_0/o_TX_Byte]
  connect_bd_net -net test_in_0_o_TX_DV [get_bd_pins UART_TX_0/i_TX_DV] [get_bd_pins test_in_0/o_TX_DV]
