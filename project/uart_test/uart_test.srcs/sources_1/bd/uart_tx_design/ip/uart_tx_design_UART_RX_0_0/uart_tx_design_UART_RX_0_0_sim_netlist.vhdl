...
-- Date        : Thu Jun 11 14:28:40 2026
-- Host        : Shef running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/WorkSpace/HDL/uart_test/uart_test.srcs/sources_1/bd/uart_tx_design/ip/uart_tx_design_UART_RX_0_0/uart_tx_design_UART_RX_0_0_sim_netlist.vhdl
-- Design      : uart_tx_design_UART_RX_0_0
...
entity uart_tx_design_UART_RX_0_0_UART_RX is
  port (
  ...
  attribute ORIG_REF_NAME of uart_tx_design_UART_RX_0_0_UART_RX : entity is "UART_RX";
end uart_tx_design_UART_RX_0_0_UART_RX;

architecture STRUCTURE of uart_tx_design_UART_RX_0_0_UART_RX is
  ...
  signal \r_Clk_Count[0]_i_2_n_0\ : STD_LOGIC;
  signal \r_Clk_Count[0]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \r_Clk_Count[8]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \r_Clk_Count[0]_i_3\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \r_Clk_Count[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_Clk_Count[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_Clk_Count[8]_i_5\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \r_Clk_Count[8]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_Clk_Count[8]_i_9\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_RX_Byte[4]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \r_RX_Byte[5]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \r_RX_Byte[6]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \r_RX_Byte[7]_i_2\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \r_SM_Main[1]_i_3\ : label is "soft_lutpair6";
...
\r_Clk_Count[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFFCE0E0000"
    )
        port map (
      I0 => \r_SM_Main_reg_n_0_[0]\,
      I1 => \r_SM_Main_reg_n_0_[1]\,
      I2 => \r_Clk_Count[0]_i_2_n_0\,
      I3 => r_RX_DV_i_2_n_0,
...
\r_Clk_Count[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \r_Clk_Count[8]_i_4_n_0\,
      I5 => i_RX_Serial,
      O => \r_Clk_Count[0]_i_2_n_0\
    );
\r_Clk_Count[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\r_Clk_Count[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \r_Clk_Count[8]_i_8_n_0\,
      I3 => \r_Clk_Count[8]_i_9_n_0\,
...
\r_Clk_Count[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => \r_Clk_Count[8]_i_8_n_0\,
      I4 => \r_Clk_Count[8]_i_9_n_0\,
...
\r_Clk_Count[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \r_Clk_Count[8]_i_8_n_0\,
      I5 => \r_Clk_Count[8]_i_9_n_0\,
...
\r_Clk_Count[5]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\r_Clk_Count[8]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\r_Clk_Count[8]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\r_Clk_Count[8]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFEFF"
    )
        port map (
...
\r_RX_Byte[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\r_RX_Byte[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_tx_design_UART_RX_0_0 is
  port (
    i_Clk : in STD_LOGIC;
    i_RX_Serial : in STD_LOGIC;
    o_RX_DV : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of uart_tx_design_UART_RX_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of uart_tx_design_UART_RX_0_0 : entity is "uart_tx_design_UART_RX_0_0,UART_RX,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of uart_tx_design_UART_RX_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of uart_tx_design_UART_RX_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of uart_tx_design_UART_RX_0_0 : entity is "UART_RX,Vivado 2018.2";
end uart_tx_design_UART_RX_0_0;

architecture STRUCTURE of uart_tx_design_UART_RX_0_0 is
...
begin
U0: entity work.uart_tx_design_UART_RX_0_0_UART_RX
     port map (
      i_Clk => i_Clk,
